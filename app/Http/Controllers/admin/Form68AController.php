...
class Form68AController extends Controller
{
    ...
    public function uploadForm68A($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', '68A')
                                ->get();
        return view('admin.uploadform.form68A',compact('landholdings','displayUploadForm'));
    }
