...
class Form68Controller extends Controller
{
    ...
    public function uploadForm68($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 68)
                                ->get();
        return view('admin.uploadform.form68',compact('landholdings','displayUploadForm'));
    }
