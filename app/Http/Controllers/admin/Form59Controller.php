...
class Form59Controller extends Controller
{
    ...
    public function uploadForm59($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 59)
                                ->get();
        return view('admin.uploadform.form59',compact('landholdings','displayUploadForm'));
    }
