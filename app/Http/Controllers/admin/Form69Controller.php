...
class Form69Controller extends Controller
{
    ...
    public function uploadForm69($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 69)
                                ->get();
        return view('admin.uploadform.form69',compact('landholdings','displayUploadForm'));
    }
