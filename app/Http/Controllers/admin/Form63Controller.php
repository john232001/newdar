...
class Form63Controller extends Controller
{
    ...
    public function uploadForm63($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 63)
                                ->get();
        return view('admin.uploadform.form63',compact('landholdings','displayUploadForm'));
    }
