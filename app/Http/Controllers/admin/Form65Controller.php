...
class Form65Controller extends Controller
{
    ...
    public function uploadForm65($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 65)
                                ->get();
        return view('admin.uploadform.form65',compact('landholdings','displayUploadForm'));
    }
