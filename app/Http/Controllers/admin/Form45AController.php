...
class Form45AController extends Controller
{
    ...
    public function uploadForm45A($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', '45A')
                                ->get();
        return view('admin.uploadform.form45A',compact('landholdings','displayUploadForm'));
    }
