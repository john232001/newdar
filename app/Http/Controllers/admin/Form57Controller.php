...
class Form57Controller extends Controller
{
    ...
    public function uploadForm57($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 57)
                                ->get();
        return view('admin.uploadform.form57',compact('landholdings','displayUploadForm'));
    }
