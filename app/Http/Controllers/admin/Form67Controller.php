...
class Form67Controller extends Controller
{
    ...
    public function uploadForm67($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 67)
                                ->get();
        return view('admin.uploadform.form67',compact('landholdings','displayUploadForm'));
    }
