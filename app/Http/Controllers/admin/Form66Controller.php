...
class Form66Controller extends Controller
{
    ...
    public function uploadForm66($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 66)
                                ->get();
        return view('admin.uploadform.form66',compact('landholdings','displayUploadForm'));
    }
