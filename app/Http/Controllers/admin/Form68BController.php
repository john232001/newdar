...
class Form68BController extends Controller
{
    ...
    public function uploadForm68B($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', '68B')
                                ->get();
        return view('admin.uploadform.form68B',compact('landholdings','displayUploadForm'));
    }
