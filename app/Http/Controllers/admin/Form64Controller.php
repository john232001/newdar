...
class Form64Controller extends Controller
{
    ...
    public function uploadForm64($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 64)
                                ->get();
        return view('admin.uploadform.form64',compact('landholdings','displayUploadForm'));
    }
