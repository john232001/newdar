...
class Form52AController extends Controller
{
    ...
    public function uploadForm52A($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', '52A')
                                ->get();
        return view('admin.uploadform.form52A',compact('landholdings','displayUploadForm'));
    }
