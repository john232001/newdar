...
class Form60Controller extends Controller
{
    ...
    public function uploadForm60($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 60)
                                ->get();
        return view('admin.uploadform.form60',compact('landholdings','displayUploadForm'));
    }
