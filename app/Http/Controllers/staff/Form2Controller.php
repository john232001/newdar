...
{
    public function selectform2($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_2')->get();
        return view('staff.form.form2', compact('landholdings','generateform'));
    }
    public function generateform($id)
    {
        ...
        $formIdentifier = 'form_2'; // Replace this with your actual form identifier
    ...
    public function uploadForm2($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 2)
                                ->get();
        return view('staff.uploadform.form2',compact('landholdings','displayUploadForm'));
    }
