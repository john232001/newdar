...
class Form54Controller extends Controller
{
    public function selectform54($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_54')->get();
        return view('staff.form.form54', compact('landholdings','generateform'));
    }
