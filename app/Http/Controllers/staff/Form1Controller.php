...
class Form1Controller extends Controller
{
    public function selectform1($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_1')->get();
        return view('staff.form.form1', compact('landholdings','generateform'));
    }
    ...
    public function uploadForm1($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 1)
                                ->get();
        return view('staff.uploadform.form1',compact('landholdings','displayUploadForm'));
    }
