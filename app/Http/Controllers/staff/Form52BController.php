...
class Form52BController extends Controller
{
    public function selectform52B($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_52B')->get();
        return view('staff.form.form52b', compact('landholdings','generateform'));
    }
    ...
    public function uploadForm52B($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', '52B')
                                ->get();
        return view('staff.uploadform.form52B',compact('landholdings','displayUploadForm'));
    }
