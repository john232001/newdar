...
class Form53Controller extends Controller
{
    public function selectform53($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_53')->get();
        return view('staff.form.form53', compact('landholdings','generateform'));
    }
    ...
    public function uploadForm53($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 53)
                                ->get();
        return view('staff.uploadform.form53',compact('landholdings','displayUploadForm'));
    }
