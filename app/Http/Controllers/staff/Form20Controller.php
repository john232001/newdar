...
class Form20Controller extends Controller
{
    public function selectform20($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_20')->get();
        return view('staff.form.form20', compact('landholdings','generateform'));
    }
    ...
    public function uploadForm20($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 20)
                                ->get();
        return view('staff.uploadform.form20',compact('landholdings','displayUploadForm'));
    }
