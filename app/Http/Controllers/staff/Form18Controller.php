...
class Form18Controller extends Controller
{
    public function selectform18($id)
    {
        ...
        $generateform = DB::table('generate_logs')->where('generate_logs.landholding_id', $id)->where('generate_logs.form_identifier', 'form_18')->get();
        return view('staff.form.form18', compact('landholdings','generateform'));
    }
    ...
    public function uploadForm18($id)
    {
        ...
        $displayUploadForm = DB::table('generated_files')
                                ...
                                ->where('generated_files.formNo', 18)
                                ->get();
        return view('staff.uploadform.form18',compact('landholdings','displayUploadForm'));
    }
