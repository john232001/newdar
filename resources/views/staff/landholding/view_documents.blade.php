    ...
    <div class="row d-flex justify-content-center">
        <div class="col-lg-6 col-md-12">
            <div class="card rounded-4">
                    ...
                    <div class="card-body">
                      <table class="table">
                        <tr>
                          ...
                          <td>
                            <a href="{{ route('staff_download_title', $items->id )}}" class="btn btn-success btn-sm rounded-5"><i class="fa-solid fa-download"></i> Download</a>
                          </td>
                        </tr>
                        <tr>
              ...
              <a href="{{ route('staff_landholding')}}" class="btn btn-success rounded-4">Go back</a>
            </div>
        </div>
    </div>
  </div>
