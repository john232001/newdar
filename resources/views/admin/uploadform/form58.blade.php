            ...
            <div class="box box-success">
              ...
              <div class="box-body">
                <div class="form-group">
                    <form action="{{ route('addfile_form58')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                        @foreach ($landholdings as $data)
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('filedownload_form58', $data->id )}}">
                        ...
                        <div class="modal-dialog modal-lg">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="{{ route('updatefile_form58', $data->id )}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group">
                                        <div class="row">
                    ...
                    <div class="modal fade" id="deletemodal{{ $data->id }}">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default pull-left" data-dismiss="modal">Close</button>
                                <a href="{{ route('deletefile_form58', $data->id )}}">
                                    <button type="submit" class="btn btn-primary">Save changes</button>
                                </a>
                            </div>
                        </div>
